...
Podemos usar também o "include", nele colocamos apenas os arquivos que queremos que sejão executados. Com isso o TS entende que todos os outros arquivos que não estão dentro do "include" não devem ser compilados.
